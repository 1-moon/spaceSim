...
SimpleMeshData concatenate( SimpleMeshData aM, SimpleMeshData const& aN )
{
	...
	aM.diffuse = aN.diffuse;
	aM.specular = aN.specular;
	aM.emission = aN.emission;
	aM.shininess = aN.shininess;
	return aM;
}
...
GLuint create_vao( SimpleMeshData const& aMeshData )
{
	...
	//Specify buffers for vertex array object
	GLuint vao = 0;
