...
TEST_CASE("4x4 rotation around Z axis", "[rotation][mat44]")
{
	...
	SECTION("143 degrees")
	{
		auto const right = make_rotation_z(2.531f);

		REQUIRE_THAT(right(0, 0), WithinAbs(-0.81931f, kEps_));
		REQUIRE_THAT(right(0, 1), WithinAbs(-0.57335f, kEps_));
		REQUIRE_THAT(right(0, 2), WithinAbs(0.f, kEps_));
		REQUIRE_THAT(right(0, 3), WithinAbs(0.f, kEps_));

		REQUIRE_THAT(right(1, 0), WithinAbs(0.57335f, kEps_));
		REQUIRE_THAT(right(1, 1), WithinAbs(-0.81931f, kEps_));
		REQUIRE_THAT(right(1, 2), WithinAbs(0.0f, kEps_));
		REQUIRE_THAT(right(1, 3), WithinAbs(0.f, kEps_));
	...
	SECTION("-27 degrees")
	{
		auto const right = make_rotation_z(-0.471239f);

		REQUIRE_THAT(right(0, 0), WithinAbs(0.89101f, kEps_));
		REQUIRE_THAT(right(0, 1), WithinAbs(0.45399f, kEps_));
		REQUIRE_THAT(right(0, 2), WithinAbs(0.f, kEps_));
		REQUIRE_THAT(right(0, 3), WithinAbs(0.f, kEps_));

		REQUIRE_THAT(right(1, 0), WithinAbs(-0.45399f, kEps_));
